...
1. Create and work within a local blockchain development environment using the JavaScript VM (now called the Remix VM (London)) provided by the Remix IDE.
...
contract JointSavings {
    ...
    */
    ...
    /*
    Finally, add the **default fallback function** so that the contract can store Ether sent from outside the deposit function.
    */
